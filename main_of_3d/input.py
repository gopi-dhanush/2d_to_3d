...
import cv2
import numpy as np
from main_of_3d.converter_3d import estimate_depth
input_img_2d_bgr=cv2.imread("C:/Users/hp/OneDrive/Pictures/Screenshots/ggg.png")
converted_2d_rgb = cv2.cvtColor(input_img_2d_bgr, cv2.COLOR_BGR2RGB) / 255.0
depth_map=estimate_depth(converted_2d_rgb)
